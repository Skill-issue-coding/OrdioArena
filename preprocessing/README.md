...
4. **Wikipedia2Vec model**
   ...
   The trained model file (`svwiki-w2v-300d.bin`, ~3–4 GB) must be placed at `preprocessing/model/svwiki-w2v-300d.bin`. See `../docs/notes/preprocessing-w2v-migration.md` for training instructions if you need to retrain it.
