/**
 * @file types.ts (hooks/websocket/types.ts)
...
import type { GameWSSendPayloadMap } from "@/hooks/game/shared"
import type { LobbyWSReceivedEvent, LobbyWSSendPayloadMap } from "../lobby/types"
