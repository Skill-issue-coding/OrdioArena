...
Synthesis of `preprocessing/plan.md` (§ _Word Selection Improvement Plan_) and
`game-design-tuning.md`, reconciled against the **actual current code** (not the
...
**Key correction on Problem B:** the stage_4 _valid-guess_ vocabulary is already
